...
- [Setting up a client to use SSL](#setting-up-a-client-to-use-ssl)
...
- [Knowing whether anybody is using a specific table](#knowing-whether-anybody-is-using-a-specific-table)
